...
describe("Dummy test", () => {
  describe("lookUpSalesPersonForZipcode", () => {
    const salesPersons: SalesPersonDirectory = [
      ...
      {
        name: "coltrane",
        email: "coltrane@exam-notifier.com",
        zipcodes: [
          "62",
          "59",
          "80",
      ...
      },
      {
        ...
        email: "philippe@exam-notifier.com",
      },
      {
        name: "lance",
        email: "lance@exam-notifier.com",
        zipcodes: [
          "76",
          "27",
          "78",
      ...
      {
        name: "john",
        email: "john@exam-notifier.com",
        zipcodes: ["974", "976"],
      },
      {
        name: "mike",
        email: "mike@exam-notifier.com",
