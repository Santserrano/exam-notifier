...
describe("WhatsAppNotification", () => {
  ...
  it("Debería formatear los números de teléfono correctamente.", async () => {
    ...
    expect(notification["formatPhoneNumber"]("11 2345-6789")).toBe(
      "541123456789",
    );
    expect(notification["formatPhoneNumber"]("+54 9 11 2345 6789")).toBe(
      "5491123456789",
    );
    expect(notification["formatPhoneNumber"]("5491123456789")).toBe(
      "5491123456789",
    );
  });
