  ...
  describe('Endpoints GET', () => {
    describe('GET /mesas', () => {
      ...
      it('debería manejar errores al obtener mesas', async () => {
        mesaService.getAllMesas.mockRejectedValue(new Error('Error de base de datos'));
    ...
    describe('GET /mesas/:id', () => {
      ...
      it('debería manejar errores al obtener mesa por ID', async () => {
        mesaService.getMesaById.mockRejectedValue(new Error('Error de base de datos'));
    ...
    describe('GET /mesas/profesor/:profesorId', () => {
      ...
      it('debería manejar errores al obtener mesas por profesor', async () => {
        mesaService.getMesasByProfesorId.mockRejectedValue(new Error('Error de base de datos'));
        
        const response = await request(app)
          .get('/api/mesas/profesor/prof1')
          .expect(500);
          
        expect(response.body).toEqual({ error: 'Error al obtener las mesas del profesor' });
      });
    });
    ...
    describe('GET /profesores', () => {
      ...
      it('debería manejar errores al obtener profesores', async () => {
        profesorService.getAllProfesores.mockRejectedValue(new Error('Error de base de datos'));
        
        const response = await request(app)
          .get('/api/profesores')
          .expect(500);
          
        expect(response.body).toEqual({ error: 'Error al obtener los profesores' });
      });
    });
  ...
  describe('Endpoints POST', () => {
    ...
    describe('POST /mesas', () => {
      it('debería crear una nueva mesa', async () => {
        mesaService.createMesa.mockResolvedValue({ success: true, data: mockMesa });
  ...
  describe('Endpoints PUT', () => {
    ...
    describe('PUT /mesas/:id', () => {
      ...
      it('debería manejar errores al actualizar mesa', async () => {
        mesaService.updateMesa.mockRejectedValue(new Error('Error de base de datos'));
  ...
  describe('Endpoints DELETE', () => {
    describe('DELETE /mesas/:id', () => {
      ...
      it('debería manejar errores al eliminar mesa', async () => {
        mesaService.deleteMesa.mockRejectedValue(new Error('Error de base de datos'));
