    ...
    <Modal open={true} onClose={onClose} title="Configurar Profesor">
      <div className="max-h-[70vh] space-y-6 overflow-y-auto p-2 md:p-4">
        ...
        <div className="mt-4 flex justify-end space-x-2">
          <Button onClick={onClose} variant="outline" className="px-4 py-1" disabled={isSubmitting}>
            Cancelar
          </Button>
          <Button
            onClick={handleSave}
            className="relative rounded bg-green-600 px-6 py-1 text-white shadow hover:bg-green-700"
            disabled={isSubmitting}
          >
            {isSubmitting ? (
              <>
